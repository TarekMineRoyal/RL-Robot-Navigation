...
class DQNAgent:
    def __init__(self, state_dim: int = None, action_dim: int = None):
        self.state_dim = state_dim or config.observation_size
        self.action_dim = action_dim or config.action_size
    ...
    def _build_model(self) -> tf.keras.Model:
        """Builds the deep neural network for the Q-function."""
    ...
    def compute_loss(self, states, actions, rewards, next_states, done_vals) -> tf.Tensor:
        """Calculates the Mean Squared Error (MSE) loss for the DQN."""
    ...
    def train_step(self, states, actions, rewards, next_states, done_vals) -> tf.Tensor:
        """Performs a single gradient descent step and soft updates the target network."""
    ...
    def _update_target_network(self):
        """Softly updates the target network weights."""
